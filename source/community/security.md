...
2. Collaborative Fix (The Embargo Period)
   ...
   * [ ] **Request CVE**:
     * Click the "Request CVE ID" button. GitHub (acting as the CNA) will usually assign a CVE-2026-XXXXX identifier within 24–48 hours. Keep this draft.
...
If your GitHub Actions workflows are complex and must run to verify the fix, the community standard in 2026 is:
